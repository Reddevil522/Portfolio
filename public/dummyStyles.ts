...
export const sidebarStyles = {
  ...
  // Desktop sidebar
  desktopSidebar: "hidden md:flex flex-col w-[300px] h-screen px-6 py-8 bg-zinc-950 border-r border-zinc-800 fixed left-0 top-0 overflow-y-auto",
  ...
  socialList: "mt-3 flex items-center justify-between gap-2 text-xs",
  socialItem: "group flex items-center gap-1.5 text-zinc-300 hover:text-zinc-50 transition-colors",
  socialIcon: "w-4 h-4",
  ...
  mobileSocialList: "flex items-center justify-between gap-2",
  mobileSocialItem: "flex items-center gap-1.5 py-2 rounded-lg text-zinc-300 hover:text-zinc-50 transition-colors",
...
export const profileImageStyles = {
  ...
  // Image container
  heroImageContainer: "relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 xl:w-72 xl:h-72 shrink-0 group perspective-1000",
